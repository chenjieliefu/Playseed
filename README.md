...
Playseed 是一个 macOS 本机 AI 游戏创作原型。用户用中文说出想法，Playseed 帮助他整理方案、准备素材、生成可以试玩的 Godot 游戏，并通过继续对话修改和恢复版本。
...
2. 在创作主页说出游戏想法，可用圆形“＋”提供参考图或提前选择空文件夹。
...
详细调用链见 [系统架构](docs/03-系统架构.md)。当前稳定范围是小型 2D 游戏；已接通单张图片生成、预览采用及素材保存；基础WAV音效、背景音乐与音量已接通；3D、联网和公开发布尚未接通。准确范围见 [当前能力与边界](docs/04-当前能力与边界.md)。
